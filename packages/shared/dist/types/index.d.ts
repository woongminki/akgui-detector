...
export type PostTag = '야근' | '인격모독' | '업무지시' | '평가' | '회식' | '보고' | '회의' | '기타';
...
export type PatternCategory = 'emotion_ignore' | 'blame_shift' | 'overwork_normalize' | 'pressure' | 'empathy_lack';
...
export type PredefinedComment = '힘내세요' | '공감해요' | '화이팅' | '응원합니다' | '같은 경험이 있어요';
...
export type ReportReason = 'harassment' | 'spam' | 'privacy_violation' | 'inappropriate' | 'other';
...
export type FilterRuleCategory = 'realname' | 'contact' | 'assertion' | 'profanity' | 'hate';
...
export type AuditAction = 'blind_post' | 'delete_post' | 'blind_comment' | 'delete_comment' | 'restrict_user' | 'unrestrict_user' | 'dismiss_report' | 'update_filter_rule';
